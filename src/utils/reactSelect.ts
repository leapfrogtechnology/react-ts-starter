 ...
 * @returns {Array}
 */
export const generateReactSelectOptionsFromObject = (array: any[], model = { value: 'id', label: 'name' }) =>
 ...
 * @returns {Array}
 */
export const generateReactSelectOptions = (array: string[]) => array.map(value => ({ value, label: value }));
